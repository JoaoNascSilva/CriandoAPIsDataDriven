...
namespace Shop.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        [Route("")]
        [AllowAnonymous]        
        [ResponseCache(VaryByHeader = "User-Agent", Location = ResponseCacheLocation.Any, Duration = 30)] //* Realiza cache somente do método

        //* Desabilita do Cache somente para este método, (quando no Startup.cs), está para cachear toda a aplicação
